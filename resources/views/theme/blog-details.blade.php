...
@section('site-main')
    @include('theme.partials.sm-hero-banner', ['title'=>'Blog Details'])
            ...
            <div class="main_blog_details">
              ...
              <div class="comment-form">
                  ...
                  <form>
                      ...
                      <div class="form-group">
                          <textarea class="mb-10 form-control" rows="5" name="message" placeholder="Messege" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Messege'" required=""></textarea>
                      </div>
